...
Let's say you have the following object in javascript, where each key/property is the type of currency note (£5, £10 and £20 note), and the value is the number of notes in the wallet.
